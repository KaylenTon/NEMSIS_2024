...
# For KL Divergence formula (temporary)
codes_NA <- select_data %>% 
...
#TEMPORARY - Rename Columns and Code Values separated by underscores:
clean_NA <- clean_NA %>%
  rename(
  ...
  mutate(
    dispatch_reason = recode(
      dispatch_reason,
      "2301001" = "abdominal_pain_problems",
      "2301003" = "allergic_reaction_stings",
      "2301005" = "animal_bite",
      "2301007" = "assault",
      "2301009" = "automated_crash_notification",
      "2301011" = "back_pain_nontraumatic",
      "2301013" = "breathing_problem",
      "2301015" = "burns_explosion",
      "2301017" ="carbon_monoxide_hazmat_inhalation_cbrn",
      "2301019" = "cardiac_arrest_death",
      "2301021" = "chest_pain_nontraumatic",
      "2301023" = "Choking",
  ...
  mutate(
    ...
    patient_race = recode(
      patient_race,
      "2514001" = "american_indian_alaska_native",
      "2514003" = "asian",
      "2514005" = "black_afamerican",
      "2514007" = "hispanic_latino",
      "2514009" = "nathawaiian_pacific_islander",
      "2514011" = "white",
      "2514013" = "middle_eastern_north_african")
  ) %>% 
...
# Rename Columns and Code Values for clean_NA:
clean_NA <- clean_NA %>%
  rename(
    dispatch_reason = eDispatch_01,
    EMD_performed = eDispatch_02,
...
event_df <- final_clean_NA %>% 
  select(PcrKey, dispatch_reason:type_of_response_delay)

# Time table --------------------------------------------------------------

time_df <- final_clean_NA %>% 
  select(PcrKey, EMSTransportTimeMin, EMSTotalCallTimeMin, PSAP_call_datetime:unit_back_in_service_datetime)
